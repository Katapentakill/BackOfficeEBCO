...
import { MdShoppingCart, MdDescription, MdCheckCircle, MdSchedule, MdWarning, MdCancel, MdPerson, MdDownload, MdOutlineTableChart, MdPictureAsPdf } from "react-icons/md";
...
export default function ProductosPage() {
  ...
  // Entregables de Productos y Soportes
  const [deliverables, setDeliverables] = useState<Deliverable[]>([
    {
      id: "1",
      name: "Coordinación de despacho EE.TT",
      period: "Diario" as const,
      dueDate: formatDateLocal(new Date(Date.now() + 0 * 24 * 60 * 60 * 1000)),
      status: "Pendiente" as const,
      assignedTo: "R. Martínez",
      progress: 0,
      lastCompletedDate: formatDateLocal(new Date(Date.now() - 1 * 24 * 60 * 60 * 1000)),
      isUrgent: false,
      pendingReason: "",
      requiredSignatures: ["Jefe de Productos", "Coordinador de Obra"],
      completedSignatures: ["Jefe de Productos"],
      observations: ""
    },
    {
      id: "2",
      ...
      assignedTo: "L. Fernández",
      progress: 0,
      lastCompletedDate: formatDateLocal(new Date(Date.now() - 10 * 24 * 60 * 60 * 1000)),
      isUrgent: true,
      pendingReason: "",
      requiredSignatures: ["Supervisor de Subcontratos", "Jefe de Productos"],
      completedSignatures: [],
      observations: ""
    },
    {
      ...
      assignedTo: "P. Sánchez",
      progress: 0,
      lastCompletedDate: formatDateLocal(new Date(Date.now() - 17 * 24 * 60 * 60 * 1000)),
      isUrgent: false,
      pendingReason: "",
      requiredSignatures: ["Jefe Legal", "Jefe de Productos"],
      completedSignatures: [],
      observations: ""
    },
    {
      ...
      period: "Quincenal" as const,
      dueDate: formatDateLocal(new Date(Date.now() + 8 * 24 * 60 * 60 * 1000)),
      status: "Completado" as const,
      assignedTo: "M. González",
      progress: 100,
      lastCompletedDate: formatDateLocal(new Date(Date.now() - 0 * 24 * 60 * 60 * 1000)),
      isUrgent: false,
      pendingReason: "",
      requiredSignatures: ["Contador", "Jefe de Productos"],
      completedSignatures: ["Contador", "Jefe de Productos"],
      observations: ""
    },
    {
      id: "5",
      name: "Cuadros Comparativos EE.TT",
      period: "Semanal" as const,
      dueDate: formatDateLocal(new Date(Date.now() + 3 * 24 * 60 * 60 * 1000)),
      status: "Urgente" as const,
      assignedTo: "A. Torres",
      progress: 0,
      lastCompletedDate: formatDateLocal(new Date(Date.now() - 4 * 24 * 60 * 60 * 1000)),
      isUrgent: true,
      pendingReason: "",
    ...
    {
      id: "6",
      name: "Solicitud Pedido EE.TT",
      period: "Semanal" as const,
      dueDate: formatDateLocal(new Date(Date.now() + 6 * 24 * 60 * 60 * 1000)),
      status: "Pendiente" as const,
      assignedTo: "C. Ramírez",
      progress: 0,
    ...
    {
      id: "7",
      name: "Reporte Mensual Productos",
      period: "Mensual" as const,
      dueDate: formatDateLocal(new Date(Date.now() + 20 * 24 * 60 * 60 * 1000)),
      status: "Pendiente" as const,
      assignedTo: "J. Morales",
      progress: 0,
      lastCompletedDate: formatDateLocal(new Date(Date.now() - 30 * 24 * 60 * 60 * 1000)),
      isUrgent: false,
      pendingReason: "",
      requiredSignatures: ["Jefe de Productos", "Coordinador General"],
      completedSignatures: [],
      observations: ""
    }
  ]);
  ...
  return (
    <div className="w-full max-w-full overflow-x-hidden px-2 sm:px-4 md:px-8 py-4 md:py-8">
      ...
      <section className="mb-8 sm:mb-12">
        ...
        {(() => {
          ...
          const formats: { [key: string]: FormatItem[] } = {
            "Diarios": [
              {
                title: "Coordinación de Despacho EE.TT",
                description: "Formato para la coordinación y control de despachos diarios de materiales con especificaciones técnicas.",
                lastUpdate: "2025-01-15",
                fileType: "excel"
              },
              {
                title: "Solicitud Pedido EE.TT",
                description: "Plantilla para solicitar pedidos de materiales con especificaciones técnicas diarias.",
            ...
            "Semanales": [
              {
                title: "Cuadros Comparativos EE.TT",
                description: "Formato para generar cuadros comparativos de materiales con especificaciones técnicas.",
                lastUpdate: "2025-01-25",
                fileType: "excel"
              },
              {
                title: "Análisis Técnico de Materiales",
                description: "Plantilla para análisis técnico de materiales y especificaciones.",
            ...
            "Quincenales": [
              {
                title: "Cubicaciones SC",
                description: "Formato quincenal para cubicaciones de subcontratos.",
                lastUpdate: "2025-01-15",
                fileType: "excel"
              },
              {
                title: "Contratos SC",
                description: "Plantilla quincenal para la elaboración y seguimiento de contratos de subcontratos.",
                lastUpdate: "2025-01-18",
                fileType: "pdf"
              },
              {
                title: "HES Subcontratos",
                description: "Formato para elaboración de Hojas de Especificaciones de Subcontratos.",
                lastUpdate: "2025-01-20",
                fileType: "pdf"
              }
            ],
            "Mensuales": [
              {
                title: "Reporte Mensual Productos y Soportes",
                description: "Plantilla mensual para el reporte consolidado de productos y soportes.",
                lastUpdate: "2025-01-01",
                fileType: "excel"
              },
              {
                title: "Especificaciones Técnicas (EETT)",
                description: "Formato mensual para la elaboración de especificaciones técnicas completas.",
      ...
      {/* Document Manager */}
      <DocumentManager title="Documentos del Área de Productos y Soportes" />
    </div>
  );
}
