...
export default function DashboardAnalisisPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 space-y-6 max-w-full overflow-x-hidden">
      ...
      <section className="bg-white rounded-lg shadow-sm p-4 md:p-6" style={{ borderColor: "var(--color-brand-line)", borderWidth: "1px", borderStyle: "solid" }}>
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold ink">Módulo 3: Dashboard de Gestión</h1>
